...
def porcentaje_a_gpa(porcentaje):
    ...
    #TOME LOS PORCENTAJES EN BASE A ESTE LINK: https://gpacalculator.net/gpa-scale/
    elif porcentaje in range(90, 93):
        return 3.7
    elif porcentaje in range(87, 90):
        return 3.3
    elif porcentaje in range(83, 87):
        return 3.0
    elif porcentaje in range(80, 83):
        return 2.7
    elif porcentaje in range(77, 80):
        return 2.3
    elif porcentaje in range(73, 77):
        return 2.0
    elif porcentaje in range(70, 73):
        return 1.7
    elif porcentaje in range(67, 70):
        return 1.3
    elif porcentaje in range(65, 67):
        return 1.0
    else:
        return 0.0
...
if total_creditos > 0:
    ...
    print(f"Tu GPA estimado para el semestre es: {gpa_semestre:.2f}")
else:
