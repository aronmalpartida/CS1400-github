...
def ejecutar_demo():
    # 1. Datos de entrada
    texto_base = "Porque estoy solito... no hay nadie aquí a mi lado... no habrá problemas hoy , de mí ya se han burlado, ¡amigos no tendré!"
    ...
    resultado = generar_texto(modelo, "no", 5)
